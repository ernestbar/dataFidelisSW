<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="sucursal_admin.aspx.cs" Inherits="proyDataFidelis.sucursal_admin" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:ObjectDataSource ID="odsSucursales" runat="server" SelectMethod="PR_PAR_GET_SUCURSALES" TypeName="proyDataFidelis.Clases.Sucursales">
	</asp:ObjectDataSource>    
	<!-- begin #content -->
