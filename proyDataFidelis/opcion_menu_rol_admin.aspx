<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="opcion_menu_rol_admin.aspx.cs" Inherits="proyDataFidelis.opcion_menu_rol_admin" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    
	<asp:ObjectDataSource ID="odsRolesActivos" runat="server" SelectMethod="PR_GET_ROLES" TypeName="proyDataFidelis.Clases.Roles">
    </asp:ObjectDataSource>
	
	<asp:ObjectDataSource ID="odsOpcionRolAsignado" runat="server" SelectMethod="PR_SEG_GET_OPCIONES_ASIGNADOS" TypeName="proyDataFidelis.Clases.Opciones_Menu_rol">
		<SelectParameters>
	...
	<asp:ObjectDataSource ID="odsOpcionRolNoAsignado" runat="server" SelectMethod="PR_SEG_GET_OPCIONES_A_ASIGNAR" TypeName="proyDataFidelis.Clases.Opciones_Menu_rol">
		<SelectParameters>
            <asp:ControlParameter ControlID="ddlMenuRol" Name="PD_MEN_COD_MENU" Type="String" />
			<asp:ControlParameter ControlID="ddlRol" Name="PB_ROL_ID_ROL" Type="String" />
