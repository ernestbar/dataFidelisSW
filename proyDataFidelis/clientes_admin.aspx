<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="clientes_admin.aspx.cs" Inherits="proyDataFidelis.clientes_admin" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        <asp:ObjectDataSource ID="odsClientesTodos" runat="server" SelectMethod="PR_SEG_GET_CLIENTES" TypeName="proyDataFidelis.Clases.Clientes">
		</asp:ObjectDataSource>
	<asp:ObjectDataSource ID="odsCiudad" runat="server" SelectMethod="PR_PAR_GET_DOMINIOS" TypeName="proyDataFidelis.Clases.Dominios">
        <SelectParameters>
			<asp:Parameter Name="PV_DOMINIO" DefaultValue="CIUDAD" />
        </SelectParameters>
    </asp:ObjectDataSource>

	<asp:ObjectDataSource ID="odsPais" runat="server" SelectMethod="PR_PAR_GET_DOMINIOS" TypeName="proyDataFidelis.Clases.Dominios">
        <SelectParameters>
												...
												<table id="data-table-buttons" class="table table-striped table-bordered">
													...
													<tbody>
														...
														<ItemTemplate>
															...
															<td><asp:Label ID="lblRazonSocial1" runat="server" Text='<%# Eval("CLI_CONTACTO") %>'></asp:Label></td>
															<td><asp:Label ID="lblMedioContacto0" runat="server" Text='<%# Eval("CLI_TELEFONO") %>'></asp:Label></td>
															<td><asp:Label ID="lblMedioContacto1" runat="server" Text='<%# Eval("CLI_EMAIL") %>'></asp:Label></td>
															<td><asp:Label ID="lblMedioContacto7" runat="server" Text='<%# Eval("DESC_TIPO_PAIS") %>'></asp:Label></td>
															<td><asp:Label ID="lblMedioContacto8" runat="server" Text='<%# Eval("DESC_TIPO_CIUDAD") %>'></asp:Label></td>
															<td><asp:Label ID="lblMedioContacto9" runat="server" Text='<%# Eval("DESC_ESTADO") %>'></asp:Label></td>
															
															<td>
																<asp:Button ID="btnCuentas"  class="btn btn-success btn-sm"  CommandArgument='<%# Eval("CLI_ID_CLIENTE")+"|"+Eval("CLI_RAZON_SOCIAL") %>' OnClick="btnCuentas_Click" runat="server" Text="Cuentas" ToolTip="Administrar cuentas" />
			...
			<div class="row">
				...
				<div class="col-md-6 offset-md-2">
					...
					<legend class="no-border f-w-700 p-b-0 m-t-0 m-b-20 f-s-16 text-inverse">Datos Cliente</legend>
						...
						<div class="form-group row m-b-10">
							...
							<div class="col-md-6">
								...
								<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="*" ControlToValidate="txtContacto" Font-Bold="True"></asp:RequiredFieldValidator>
							</div>
					...
					<div class="form-group row m-b-10">
						...
						<div class="col-md-6">
                             			<asp:DropDownList ID="ddlPais" class="form-control"   DataSourceID="odsPais" DataTextField="descripcion" DataValueField="codigo" OnDataBound="ddlPais_DataBound" runat="server"></asp:DropDownList>
							<asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="*" ForeColor="Red" ControlToValidate="ddlPais" InitialValue="SELECCIONAR"  Font-Bold="True"></asp:RequiredFieldValidator>
						</div>
					</div>
					<!-- end form-group row -->		
						<!-- begin form-group row -->
					<div class="form-group row m-b-10">
						...
						<div class="col-md-6">
                             			<asp:DropDownList ID="ddlCiudad" class="form-control"   DataSourceID="odsCiudad" DataTextField="descripcion" DataValueField="codigo" OnDataBound="ddlCiudad_DataBound" runat="server"></asp:DropDownList>
							<asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="*" ForeColor="Red" ControlToValidate="ddlCiudad" InitialValue="SELECCIONAR"  Font-Bold="True"></asp:RequiredFieldValidator>
						</div>
					</div>
					<!-- end form-group row -->		
