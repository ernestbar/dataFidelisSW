<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="personal_admin.aspx.cs" Inherits="proyDataFidelis.personal_admin" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	<asp:ObjectDataSource ID="odsPersonalClientes" runat="server" SelectMethod="PR_PAR_GET_PERSONAL" TypeName="proyDataFidelis.Clases.Usuarios">
		</asp:ObjectDataSource>
	<asp:ObjectDataSource ID="odsUsuarios" runat="server" SelectMethod="PR_PAR_GET_USUARIOS" TypeName="proyDataFidelis.Clases.Usuarios">
		<SelectParameters>
			<asp:ControlParameter ControlID="lblCodPersonal" Name="PV_COD_PERSONAL" Type="String" />
		</SelectParameters>
		</asp:ObjectDataSource>
	<asp:ObjectDataSource ID="odsRoles" runat="server" SelectMethod="PR_GET_ROLES" TypeName="proyDataFidelis.Clases.Roles">
		</asp:ObjectDataSource>
	<asp:ObjectDataSource ID="odsTipoDocumento" runat="server" SelectMethod="PR_PAR_GET_DOMINIOS" TypeName="proyDataFidelis.Clases.Dominios">
			<SelectParameters>
	...
	<asp:ObjectDataSource ID="odsPais" runat="server" SelectMethod="Lista" TypeName="proyDataFidelis.Clases.Paises">
		 </asp:ObjectDataSource>
	<asp:ObjectDataSource ID="odsSucursal" runat="server" SelectMethod="PR_PAR_GET_SUCURSALES" TypeName="proyDataFidelis.Clases.Sucursales">
		 </asp:ObjectDataSource>
